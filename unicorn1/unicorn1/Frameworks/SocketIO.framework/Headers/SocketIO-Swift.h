...
/**
  ...
  a public key
*/
- (SecKeyRef _Nullable)extractPublicKey:(SecCertificateRef _Nonnull)cert policy:(SecPolicyRef _Nonnull)policy;
/**
...
*/
- (NSArray<NSData *> * _Nonnull)certificateChain:(SecTrustRef _Nonnull)trust;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
